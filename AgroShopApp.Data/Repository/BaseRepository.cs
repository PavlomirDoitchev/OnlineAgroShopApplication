...
using static AgroShopApp.Data.Common.ExceptionMessages;
...
namespace AgroShopApp.Data.Repository
{
    public abstract class BaseRepository<TEntity, TKey>
         ...
         where TEntity : class
    {
        protected readonly AgroShopDbContext DbContext;
        protected readonly DbSet<TEntity> DbSet;

        protected BaseRepository(AgroShopDbContext dbContext)
        {
